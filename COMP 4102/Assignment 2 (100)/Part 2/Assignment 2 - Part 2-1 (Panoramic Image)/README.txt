...
1. Open the PanoramicImage.sln file in Visual Studio.
2. Change the build configuration to `Release` and have the architecture set to `x64`.
3. Click `Local Windows Debugger` and 1 window will appear showing the results of running the program (screenshot attached).
